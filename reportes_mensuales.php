    ...
    <div class="report-wrapper">
        ...
        <form method="GET" class="filter-bar no-print">
            <div style="flex-grow: 1; display: flex; gap: 10px; align-items: center;">
                ...
                <select name="zona" class="form-select" style="background: var(--tint-purple); color: var(--text-main); border: 1px solid var(--border-color); padding: 8px; border-radius: 6px;">
                ...
                <select name="mes" style="background: var(--tint-purple); color: var(--text-main); border: 1px solid var(--border-color); padding: 8px; border-radius: 6px;">
                    <?php foreach($meses as $num => $nom): ?>
                        <option value="<?= $num ?>" <?= $num == $mes_actual ? 'selected' : '' ?>><?= $nom ?></option>
                    <?php endforeach; ?>
                </select>
                
                <input type="number" name="anio" value="<?= $anio_actual ?>" style="width: 70px; background: var(--tint-purple); color: var(--text-main); border: 1px solid var(--border-color); padding: 8px; border-radius: 6px;">
            ...
            <div style="overflow-x: auto; margin-top: 15px;">
                <table class="screen-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $txt ?></td>
                            <td style="text-align: right; color: var(--text-muted);"><?= formatCurrency($fila['total_efectivo']) ?></td>
                            <td style="text-align: right; color: var(--text-muted);"><?= formatCurrency($fila['total_transferencia']) ?></td>
                            <td style="text-align: right; font-weight: bold; color: var(--text-main);"><?= formatCurrency($bruto) ?></td>
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: { display: true, text: 'Tendencia de Ingresos', color: '#1e1b4b', font: { size: 16 } }
                },
                scales: {
                    y: {
                        beginAtZero: true,
