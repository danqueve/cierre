...
$zonas = ['Zona Este', 'Zona Norte', 'Zona Sur', 'Zona Sgo', 'Leales','Catamarca', 'Tafi del Valle'];
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="card">
                ...
                <!-- Zona y Fecha -->
                <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(240px, 1fr)); gap:20px; margin-bottom:1.5rem;">
